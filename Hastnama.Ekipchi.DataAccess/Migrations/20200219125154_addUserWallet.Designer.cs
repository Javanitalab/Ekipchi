...
namespace Hastnama.Ekipchi.DataAccess.Migrations
{
    ...
    [Migration("20200219125154_addUserWallet")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Hastnama.Ekipchi.DataAccess.Entities.FinancialTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                    ...
                    b.Property<bool>("BankTransaction")
                        .HasColumnType("bit");
                    ...
                    b.Property<int>("TeTransactionStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Hastnama.Ekipchi.DataAccess.Entities.Payment", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Hastnama.Ekipchi.DataAccess.Entities.UserWallet", b =>
                {
                    b.Property<Guid>("UserId")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Hastnama.Ekipchi.DataAccess.Entities.FinancialTransaction", b =>
                {
                    b.HasOne("Hastnama.Ekipchi.DataAccess.Entities.User", "Author")
                        .WithMany("AuthorTransactions")
                        .HasForeignKey("AuthorId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Hastnama.Ekipchi.DataAccess.Entities.User", "Payer")
                        .WithMany("PayerTransactions")
                        .HasForeignKey("PayerId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Hastnama.Ekipchi.DataAccess.Entities.User", "Receiver")
            ...
            modelBuilder.Entity("Hastnama.Ekipchi.DataAccess.Entities.Payment", b =>
                {
                    b.HasOne("Hastnama.Ekipchi.DataAccess.Entities.FinancialTransaction", "FinancialTransaction")
                        .WithMany("Payments")
