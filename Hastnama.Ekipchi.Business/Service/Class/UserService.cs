        ...
        public async Task<Result> Create(CreateUserDto dto)
        {
            ...
            if (user.Email != null)
            {
                ...
                if (duplicateUser != null)
                    return Result.Failed(new BadRequestObjectResult(new ApiMessage { Message = PersianErrorMessage.EmailAddressAlreadyExist }));
            }
            ...
            if (user.Mobile != null)
            {
                ...
                if (duplicateUser != null)
                    return Result.Failed(new BadRequestObjectResult(new ApiMessage { Message = PersianErrorMessage.MobileAlreadyExist }));
            }
            ...
            if (user.Username != null)
            {
                ...
                if (duplicateUser != null)
                    return Result.Failed(new BadRequestObjectResult(new ApiMessage { Message = PersianErrorMessage.UsernameAlreadyExist }));
            }
